...
﻿
The multi-source fusion tracking dataset contains camera images, radar images, AIS data, GNSS data, and visible videos for evaluating multi-source vessel tracking method.
